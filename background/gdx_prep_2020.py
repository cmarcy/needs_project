...
os.chdir('C:/Users/cmarcy/Desktop/py_projects/plantfile')

# =============================================================================
# Generating input files for ReEDS
# =============================================================================

nems = pd.read_csv('outputs/needs_final.csv', low_memory=False)
...
nems.to_csv('needs_final2.csv',index=False)
