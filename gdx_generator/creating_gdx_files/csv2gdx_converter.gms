...
$call csv2gdx CONVOLDqctn.csv id=d index=1..3 values=lastCol useHeader=y trace=0
...
$call csv2gdx PrescriptiveBuildsnqct.csv id=d index=1..4 values=lastCol useHeader=y trace=0
...
$call csv2gdx Nuke60RetireYear.csv id=d index=1..4 values=lastCol useHeader=y trace=0
$gdxin Nuke60RetireYear.gdx
$load Nuke60RetireYear=d

$call csv2gdx Nuke80RetireYear.csv id=d index=1..4 values=lastCol useHeader=y trace=0
$gdxin Nuke80RetireYear.gdx
$load Nuke80RetireYear=d

$call csv2gdx NukeRefRetireYear.csv id=d index=1..4 values=lastCol useHeader=y trace=0
$gdxin NukeRefRetireYear.gdx
$load NukeRefRetireYear=d

$call csv2gdx NukeEarlyRetireYear.csv id=d index=1..4 values=lastCol useHeader=y trace=0
$gdxin NukeEarlyRetireYear.gdx
$load NukeEarlyRetireYear=d

$call csv2gdx PrescriptiveRet.csv id=d index=1..4 values=lastCol useHeader=y trace=0
...
$call csv2gdx tmpCSPOct.csv id=d index=1..2 values=lastCol useHeader=y trace=0
$gdxin tmpCSPOct.gdx
$load tmpCSPOct=d
